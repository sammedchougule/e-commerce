	...
	<div class="content-blog">
		...
		<div class="container ">
			<div class="row">
				<div class="offset-md-2 col-md-8">
					...
					<h3 class="uppercase class="text-dark"">Billing Details</h3>
					...
					<div class="space30"></div>	
						...
						<div class="clearfix space20 mt-2"></div>
							<div class="row">
								<div class="col-md-6">
							...
							<div class="clearfix space20"></div>
								<input class="form-control mt-3" name='addr2' placeholder="Apartment, suite, unit etc. (optional)" value="<?php if(isset($row['address2'])) {echo $row['address2'];  } ?>" type="text">
							<div class="clearfix space20"></div>
			...
			<div class="payment-method mt-5">
				...
				<div class="row d-flex">
						...
						<div class="col-md-4">
							<input name="payment" value='COD'  id="radio1" class="mr-2 css-checkbox" type="radio"><span class="text-dark">COD</span>
							<div class="space20"></div>
							<p>Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order won't be shipped until the funds have cleared in our account.</p>
						</div>
						<!-- <div class="col-md-4">
							<input name="payment" value='Cheque'  id="radio2" class="mr-2 css-checkbox" type="radio"><span class="text-dark">Cheque Payment</span>
							<div class="space20"></div>
							<p>Please send your cheque to BLVCK Fashion House, Oatland Rood, UK, LS71JR</p>
						</div> -->
						<div class="col-md-4">
							<input name="payment" value='Paypal'  id="radio3" class="mr-2 css-checkbox" type="radio"><span class="text-dark">Paypal</span>
							<div class="space20"></div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <input type='submit' name='submit' value='Pay Now' class="btn btn-success mb-5">
            </div>
        </div>
